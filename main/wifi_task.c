...
static void event_handler_on_sta_got_ip(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data){
...
static void event_handler_on_wifi_sta_start(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data){
    esp_wifi_connect();
}
...
void connect_wifi(void) {
    ...
    ESP_ERROR_CHECK(esp_event_handler_register(WIFI_EVENT, WIFI_EVENT_STA_START, &event_handler_on_wifi_sta_start, NULL));
